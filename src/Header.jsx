...
function Header({ page, onPageChange, subTab, onSubTabChange, dashTabs, appearance = "auto", onAppearanceChange }) {
  ...
  return (
    ...
    <div ref={wrapperRef} className={`hdr-wrapper${hdrHidden ? " hdr--hidden" : ""}`} style={hdrStyles.bar}>
      <header style={{ ...hdrStyles.inner, fontFamily: "-apple-system" }}>
        <div style={hdrStyles.left} className="hdr-left">
          <div style={hdrStyles.logoBox} className="hdr-logo-box">
            <img src="public/logo/nkust-logo.png" alt="NKUST" style={hdrStyles.logoImg} className="hdr-logo-img" />
          </div>
      ...
      <div className={hdrHidden ? "hdr-subbar hdr-sub--hidden" : "hdr-subbar"} style={hdrStyles.subBar}>
